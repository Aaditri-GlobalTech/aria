...
function getCallbackHost(): string {
	return typeof process !== "undefined" ? process.env.ARIA_OAUTH_CALLBACK_HOST || "127.0.0.1" : "127.0.0.1";
}
 ...
 * @param options.originator - OAuth originator parameter (defaults to "aria")
 */
