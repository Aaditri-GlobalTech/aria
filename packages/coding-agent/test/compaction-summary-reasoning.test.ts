...
import type { AssistantMessage, Model } from "@aaditri-globaltech/aria-ai";
...
vi.mock("@aaditri-globaltech/aria-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@aaditri-globaltech/aria-ai")>();
	return {
		...actual,
