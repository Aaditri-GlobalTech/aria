...
import { Text, type TUI } from "@aaditri-globaltech/aria-tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".aria", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .aria/AGENTS.md",
	...
	for (const scenario of [
		...
		{ title: "Aria documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
