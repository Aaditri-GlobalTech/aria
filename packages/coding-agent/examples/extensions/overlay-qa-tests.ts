 ...
 *
 * Usage: aria --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@aaditri-globaltech/aria-coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@aaditri-globaltech/aria-tui";
import { Input, matchesKey, truncateToWidth, visibleWidth } from "@aaditri-globaltech/aria-tui";
...
export default function (aria: ExtensionAPI) {
	...
	aria.registerCommand("overlay-animation", {
	...
	aria.registerCommand("overlay-anchors", {
	...
	aria.registerCommand("overlay-margins", {
	...
	aria.registerCommand("overlay-stack", {
	...
	aria.registerCommand("overlay-overflow", {
	...
	aria.registerCommand("overlay-edge", {
	...
	aria.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	aria.registerCommand("overlay-maxheight", {
	...
	aria.registerCommand("overlay-sidepanel", {
	...
	aria.registerCommand("overlay-toggle", {
	...
	aria.registerCommand("overlay-passive", {
	...
	aria.registerCommand("overlay-focus", {
	...
	aria.registerCommand("overlay-streaming", {
	...
	private startProcess(): void {
		...
		this.proc = spawn("bash", [
			...
			for i in $(seq 1 100); do
				...
				DIR="/Users/nicobailon/Documents/development/aria/packages/coding-agent/src/modes/interactive"
				...
				if [ $((i % 5)) -eq 0 ]; then
					echo -e "  \\033[32m✓ Successfully processed \${i} files in /Users/nicobailon/Documents/development/aria\\033[0m"
				fi
				if [ $((i % 7)) -eq 0 ]; then
