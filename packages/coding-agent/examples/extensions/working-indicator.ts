 ...
 * working indicator shown while aria is streaming a response.
 *
 * Usage:
 *   aria --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore aria's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@aaditri-globaltech/aria-coding-agent";
...
export default function (aria: ExtensionAPI) {
	...
	aria.registerCommand("working-indicator", {
