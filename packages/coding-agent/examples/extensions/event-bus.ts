 ...
 *
 * Shows aria.events for communication between extensions. One extension
...
export default function (aria: ExtensionAPI) {
	...
	aria.events.on("my:notification", (data) => {
