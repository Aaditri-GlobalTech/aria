 ...
 * Commands Extension
 *
 * Demonstrates the aria.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@aaditri-globaltech/aria-coding-agent";

export default function commandsExtension(aria: ExtensionAPI) {
	aria.registerCommand("commands", {
