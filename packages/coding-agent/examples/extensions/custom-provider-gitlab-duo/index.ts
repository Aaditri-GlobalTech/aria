 ...
 * Delegates to aria-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   aria -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (aria: ExtensionAPI) {
	aria.registerProvider("gitlab-duo", {
