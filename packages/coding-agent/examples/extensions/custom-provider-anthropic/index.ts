 ...
 *   aria -e ./packages/coding-agent/examples/extensions/custom-provider
 *
 *   # With API key
 *   CUSTOM_ANTHROPIC_API_KEY=sk-ant-... aria -e ./packages/coding-agent/examples/extensions/custom-provider
 *
...
export default function (aria: ExtensionAPI) {
	aria.registerProvider("custom-anthropic", {
