 ...
 *
 * Usage: aria --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@aaditri-globaltech/aria-tui";

export default function (aria: ExtensionAPI) {
	aria.registerCommand("overlay-test", {
