...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/Aaditri-GlobalTech/aria/releases/latest`;
	}
	const command = getSelfUpdateCommandForMethod(method, packageName, updatePackageName, npmCommand);
	if (command) {
...
export function getPackageDir(): string {
	...
	const envDir = process.env.ARIA_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json ariaConfig)
// =============================================================================
...
const ariaConfigName: string | undefined = pkg.ariaConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "@aaditri-globaltech/aria-coding-agent";
export const APP_NAME: string = ariaConfigName || "aria";
export const APP_TITLE: string = APP_NAME;
export const CONFIG_DIR_NAME: string = pkg.ariaConfig?.configDir || ".aria";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., ARIA_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
const DEFAULT_SHARE_VIEWER_URL = "https://aria.dev/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.ARIA_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.aria/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.aria/agent/) */
