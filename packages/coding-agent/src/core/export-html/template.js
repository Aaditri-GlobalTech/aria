    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="aria-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="aria-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'aria-share:v1:sidebar-width';
