import { type AgentMessage, uuidv7 } from "@aaditri-globaltech/aria-agent";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, undefined/false if aria-generated */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, false if aria-generated */
	fromHook?: boolean;
}
 ...
 * Encodes cwd into a safe directory name under ~/.aria/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.aria/agent/sessions/<encoded-cwd>/).
	 */
