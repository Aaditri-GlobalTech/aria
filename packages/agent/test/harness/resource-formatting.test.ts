...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.aria/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.aria/skills/inspect/SKILL.md">\nReferences are relative to /project/.aria/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});
